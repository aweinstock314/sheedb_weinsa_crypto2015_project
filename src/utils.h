...
error_code enserialcrypt_cts(const char* cryptkey, const char* signkey,
    const struct cts_payload* src, struct client_to_server* dst);
error_code deserialcrypt_cts(const char* cryptkey, const char* signkey,
    const struct client_to_server* src, struct cts_payload* dst);
error_code enserialcrypt_stc(const char* cryptkey, const char* signkey,
    const struct stc_payload* src, struct server_to_client* dst);
error_code deserialcrypt_stc(const char* cryptkey, const char* signkey,
